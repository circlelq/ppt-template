...
\author[Name]{袁磊祺 \inst{$\dagger$} and supervisor's name} %With inst, you can change the institution they belong
\subtitle{Subtitle}
\institute[uni]{\inst{$\dagger$} 北京大学工学院力学与工程科学系}
\date{\today} %Here you can change the date
\titlegraphic{\vspace{0.5cm}\hfill\includegraphics[scale=0.23]{pkured.pdf}} %You can modify the location of the logo by changing the command \vspace{}.
